...
- [ ] **可选工程案例：**按 [ReplaySSM 教学卡](https://huasushis.github.io/sparse-linear-attention/part3/13-fla-code-map/#1312-replayssm) 做 `B=H=1,T<=32` 的 recurrent/output-only 对齐，再用 Lab 4B 测一个 buffer length；它是 B* 补充项，不改变 74 篇论文主线。
