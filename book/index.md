...
这是一本面向初学者、但不回避真实实现细节的研究教程。它的目标不是替你把 74 篇论文总结完，而是让你逐步获得三种能力：
...
!!! tip "从哪里开始"
    只从[第 0 章：学习控制台](start-here.md)开始。它在同一页列出当前任务、站内阅读链接、作业位置和通过条件。你现在先完成 P0；不要先安装 FLA、Triton 或下载大模型。
